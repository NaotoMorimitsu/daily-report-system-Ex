...
<label for="${AttributeConst.REP_IN.getValue()}">出勤時間</label><br />
<input type="text" name="${AttributeConst.REP_IN.getValue()}" id="${AttributeConst.REP_IN.getValue()}" value="${report.in_time}" />
<br /><br />

<label for="${AttributeConst.REP_OUT.getValue()}">退勤時間</label><br />
<input type="text" name="${AttributeConst.REP_OUT.getValue()}" id="${AttributeConst.REP_OUT.getValue()}" value="${report.out_time}" />
<br /><br />
